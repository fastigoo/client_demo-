...
class MainColors {
  ...
  static Color? cardColor(BuildContext context) => Theme.of(context).extension<ColorsStyles>()?.cardColor;
  ...
  static const Color primaryColor = materialColors.Color(0xFFED7D31);
  // static const Color primaryColor = materialColors.Color(0xFFC14600);
  static const Color secondColor = materialColors.Color(0xFFF39F5A);
  // static const Color secondColor = materialColors.Color(0xFFD0FF00);
  ...
  static const primaryGradientColor = LinearGradient(
    colors: [primaryColor, Color(0xFF498CFF)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const googleGradientColor = LinearGradient(
    colors: [Color(0xFFdb4a39), Color(0xFFef3a25)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const facebookGradientColor = LinearGradient(
    colors: [Color(0xFF316FF6), Color(0xFF295de3)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
...
class LightColors {
  static const Color backgroundColor = materialColors.Color(0xFFF5F5F6);
  static const Color cardColor = materialColors.Color(0xFFFFFFFF);
  ...
  static const Color inputColor = materialColors.Color(0xFFFFFFFF);
...
class DarkColors {
  static const Color backgroundColor = materialColors.Color(0xFF151515);
  static const Color cardColor = materialColors.Color(0xFF000000);
  ...
  static const Color inputColor = materialColors.Color(0xFF212121);
